...
export default function Sidebar({ children, visible }: ISidebarProps) {
    const user = {
        name:"Anonymous User",
      ...
      >
        ...
        >
          <div className="relative flex-1 flex flex-col max-w-xs w-full bg-gray-800">
            ...
            <div className="flex-shrink-0 flex bg-gray-700 glassmorphism-75 p-4">
    ...
    <div className="hidden md:flex md:flex-shrink-0">
      <div className="flex flex-col w-64">
        ...
        <div className="flex flex-col h-0 flex-1 bg-clip-padding backdrop-filter backdrop-blur-xl bg-opacity-60 border border-gray-200">
